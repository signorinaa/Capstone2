...
<html lang="en">
  <head>
    <title>Terms-of-Service - CLIS - Student Portal</title>
    <meta
      property="og:title"
      content="Terms-of-Service - CLIS - Student Portal"
    />
    ...
    <div>
      ...
      <div class="terms-of-service-container">
        <img
          ...
          class="terms-of-service-image"
        />
        <h1 class="terms-of-service-text">Terms of Service</h1>
        <a href="index.html" class="terms-of-service-navlink">
          <img
            alt="pastedImage"
            src="public/external/pastedimage-1s3-200h.png"
            class="terms-of-service-icon-logout"
          />
        </a>
        <footer class="terms-of-service-footer">
          <span class="terms-of-service-text01">
            <span>Copyright © Conde Labac Integrated School</span>
          </span>
          <span class="terms-of-service-text03">
            <span>Conde Labac Integrated School</span>
          </span>
          <span class="terms-of-service-text05">
            <span>P4P6+5WC, Conde Labac, Batangas City</span>
          </span>
          <span class="terms-of-service-text07">
            <span>(043) 728 - 2928</span>
          </span>
          <span class="terms-of-service-text09">
            <span>condelabac@gmail.com</span>
          </span>
          <img
            alt="image"
            src="public/external/deped-emblem-removebg-preview-200h-200h.png"
            class="terms-of-service-image1"
          />
          <img
            alt="image"
            src="public/external/conde-removebg-preview-200h-200h-200h.png"
            class="terms-of-service-image2"
          />
          <img
            alt="pastedImage"
            src="public/external/pastedimage-biba-200h.png"
            class="terms-of-service-pasted-image"
          />
          <img
            alt="pastedImage"
            src="public/external/pastedimage-6vpl-200h.png"
            class="terms-of-service-pasted-image1"
          />
          <a
          ...
          >
            <img
              ...
              class="terms-of-service-facebook"
            />
          </a>
          <img
            alt="pastedImage"
            src="public/external/pastedimage-324d-200h-200h.png"
            class="terms-of-service-instagam"
          />
        </footer>
      </div>
    </div>
