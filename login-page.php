...
<html lang="en">
  <head>
    <title>Login-Page - CLIS - Student Portal</title>
    <meta property="og:title" content="Login-Page - CLIS - Student Portal" />
    ...
    <div>
      ...
      <div class="login-page-container">
        <div class="login-page-container1">
          <div class="login-page-container2">
            ...
            <h1 class="login-page-text">
              <span class="login-page-text01">CONDE LABAC&nbsp;</span>
              <br class="login-page-text02" />
              <span class="login-page-text03">INTEGRATED&nbsp;</span>
              <br class="login-page-text04" />
              <span class="login-page-text05">SCHOOL</span>
              <br />
            </h1>
            <span class="login-page-text07">
              Changing lives igniting success
            </span>
          </div>
          <div class="login-page-container3">
            <a href="./student/student-login.php" class="login-page-navlink button">
              STUDENT
            </a>
            <span class="login-page-text08">LOG IN AS :&nbsp;</span>
            <a href="./teacher/teachers-login.php" class="login-page-navlink1 button">
              TEACHER
            </a>
            <a href="index.php" class="login-page-navlink2">
              <svg viewBox="0 0 1024 1024" class="login-page-icon">
                <path
        ...
        <footer class="login-page-footer">
          ...
          <span class="login-page-text11">
            <span>Conde Labac Integrated School</span>
          </span>
          <span class="login-page-text13">
            <span>P4P6+5WC, Conde Labac, Batangas City</span>
          </span>
          <span class="login-page-text15"><span>(043) 728 - 2928</span></span>
          <span class="login-page-text17">
          ...
          <img
            ...
            class="login-page-pasted-image"
          />
          <img
            alt="pastedImage"
            src="public/external/pastedimage-6vpl-200h.png"
            class="login-page-pasted-image1"
          />
          <a
          ...
          >
            <img
              ...
              class="login-page-facebook"
            />
          </a>
          <img
            alt="pastedImage"
            src="public/external/pastedimage-324d-200h-200h.png"
            class="login-page-instagam"
          />
        </footer>
      </div>
    </div>
