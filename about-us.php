...
<html lang="en">
  <head>
    <title>About-Us - CLIS - Student Portal</title>
    <meta property="og:title" content="About-Us - CLIS - Student Portal" />
  ...
  <body>
    ...
    <div>
      ...
      <div class="about-us-container">
        ...
        <a href="index.html" class="about-us-navlink">
          <img
            alt="pastedImage"
            src="public/external/pastedimage-1s3-200h.png"
            class="about-us-icon-logout"
          />
        </a>
        <footer class="about-us-footer">
          <span class="about-us-text01">
            <span>Copyright © Conde Labac Integrated School</span>
          </span>
          <span class="about-us-text03">
            <span>Conde Labac Integrated School</span>
          </span>
          <span class="about-us-text05">
            <span>P4P6+5WC, Conde Labac, Batangas City</span>
          </span>
          <span class="about-us-text07"><span>(043) 728 - 2928</span></span>
          <span class="about-us-text09"><span>condelabac@gmail.com</span></span>
          <img
            alt="image"
          ...
          <img
            ...
            class="about-us-pasted-image"
          />
          <img
            alt="pastedImage"
            src="public/external/pastedimage-6vpl-200h.png"
            class="about-us-pasted-image1"
          />
          <a
