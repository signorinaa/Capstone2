...
<html lang="en">
  <head>
    <title>Privacy-Policy - CLIS - Student Portal</title>
    <meta
      property="og:title"
      content="Privacy-Policy - CLIS - Student Portal"
    />
      ...
      <div class="privacy-policy-container">
        ...
        <footer class="privacy-policy-footer">
          ...
          <img
            ...
            class="privacy-policy-pasted-image"
          />
          <img
            alt="pastedImage"
            src="public/external/pastedimage-6vpl-200h.png"
            class="privacy-policy-pasted-image1"
          />
          <a
          ...
          >
            <img
              ...
              class="privacy-policy-facebook"
            />
          </a>
          <img
            alt="pastedImage"
            src="public/external/pastedimage-324d-200h-200h.png"
            class="privacy-policy-instagam"
          />
        </footer>
      </div>
    </div>
